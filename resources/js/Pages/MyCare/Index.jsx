...
export default function Index({ products }) {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`/products/update/${editProduct.id}`, data, {
                headers: {
            ...
            setProducts(userProducts.map(prod =>
                prod.id === response.data.product.id ? response.data.product : prod
            ));
        } catch (error) {
    ...
    return <>
            ...
            <div className="menu">
                <div className="menuHide">
                    ...
                    <div className="menuChoiser">
                        <a className="holovna" href="./homePage.html">Головна</a>
        ...
        <form className="filters" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="applyBtn">Застосувати фільтри</button>
        </form>
                ...
                userProducts.map(el =>
                    <div className="card" key={el.id}>
                        ...
                        <div className="cardDescr">
                            <div className="nameTovar">{el.name} {el.id}</div>
                        ...
                        <div className="cardActions">
                            <button className="editBtn" onClick={() => openEditModal(el)}>
                                ✏️ Редагувати
                            </button>
                            <button
                                className="deleteBtn"
        ...
        {showEditModal && (
            <>
                ...
                <div className="modalCreate">
                    <form className="createProductForm" onSubmit={handleEditSubmit}>
                        ...
                        <div className="formActions">
                            <button type="submit" className="saveBtn">Оновити</button>
