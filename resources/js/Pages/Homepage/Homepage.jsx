        ...
        <>
            ...
            <div className="howItWorkInclude">
                ...
                <div>
                    ...
                    <div>
                        Відскануйте штрих-код вашого засобу, або введіть вручну
                        номер
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div>
                        SkinCare буде нагадувати вам про важливі дати,
                        допомагаючи уникнути використання застарілих продуктів.
                    </div>
                </div>
            </div>

            <footer className="footerHome">
                <div className="footerIncludeHome">
                    <div className="footerLogoHome">
                        <i className="fa-solid fa-leaf leaf2"></i>
                        <div className="footerSKinHome">SkinCare</div>
                    </div>

                    <div className="footerСonnectionHome">
                        <div className="footerPhoneHome">
                            <i className="fa-regular fa-phone"></i>
                            <div className="phone">+380xxxxxxxxx</div>
                        </div>

                        <div className="footerEmailHome">
                            <i className="fa-regular fa-envelope"></i>
                            <div className="email">skinscancare@gmail.com</div>
                        </div>
                    </div>

                    <div className="socialNetHome">
